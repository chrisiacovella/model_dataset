...
class ModelDataset(HDF5Dataset):
    ...
    def __init__(
        ...
        data_combination : str, optional
            ...
            Options, MM_low_temp_correction, PURE_MM, PURE_ML, PURE_ML_test_molecules
        local_cache_dir: str, optional
            Path to the local cache directory, by default ".".
        ...
        self.PURE_ML_test_molecules_url = "https://www.dropbox.com/scl/fi/m581wsa5i7okmzb2f1q4i/PURE_ML_test_molecules.hdf5.gz?rlkey=vu51lc3v5ub1o2ktojkedtwou&dl=1"
        self.PURE_ML_test_conformers_url = "https://www.dropbox.com/scl/fi/8kj7c77wr4nuy3303dod7/PURE_ML_test_conformers.hdf5.gz?rlkey=stulnksv5os27bw38jvcq2jvq&st=9wrssk2m&dl=1"
        ...
        elif self.data_combination == "PURE_ML_test_molecules":
            url = self.PURE_ML_test_molecules_url
            gz_data_file = {
                "name": "PURE_ML_test_molecules_dataset.hdf5.gz",
                "md5": "5eaee05e618bac4524a07b16ace794b3",
            }

            hdf5_data_file = {
                "name": "PURE_ML_test_molecules_dataset.hdf5",
                "md5": "e2b43ad4b3e3fc148d8b29a705aab972",
            }

            processed_data_file = {
                "name": "PURE_ML_test_molecules_dataset_processed.npz",
                "md5": None,
            }

            logger.info("Using ML test molecules dataset")

        elif self.data_combination == "PURE_ML_test_conformers":
            url = self.PURE_ML_test_conformers_url
            gz_data_file = {
                "name": "PURE_ML_test_conformers_dataset.hdf5.gz",
                "md5": "0aa0dc079140aceaee56f445e4b77ce1",
            }

            hdf5_data_file = {
                "name": "PURE_ML_test_conformers_dataset.hdf5",
                "md5": "a5a656090913d155d72002f4ee1ae253",
            }

            processed_data_file = {
                "name": "PURE_ML_test_conformers_dataset_processed.npz",
                "md5": None,
            }

            logger.info("Using ML test conformers dataset")
